...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(GroupingView.class)
public class GroupingViewBuilder<M> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<GroupingViewBuilder<M>> {
