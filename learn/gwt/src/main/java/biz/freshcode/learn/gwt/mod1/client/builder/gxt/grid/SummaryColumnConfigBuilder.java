...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(SummaryColumnConfig.class)
public class SummaryColumnConfigBuilder<M, N> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<SummaryColumnConfigBuilder<M, N>> {
