package biz.freshcode.learn.gwt.mod1.client.builder.gxt.menu;
...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(Menu.class)
public class MenuBuilder extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<MenuBuilder> {
