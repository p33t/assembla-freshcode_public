...
@biz.freshcode.learn.gwt.common.client.builder.BeanBuilder(ColumnConfig.class)
public class ColumnConfigBuilder<M, N> extends biz.freshcode.learn.gwt.common.client.builder.Construct.Parent<ColumnConfigBuilder<M, N>> {
