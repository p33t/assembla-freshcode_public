package biz.freshcode.learn.gwt.mod1.client.builder.gxt.chart.axis;
...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(CategoryAxis.class)
public class CategoryAxisBuilder<M, V> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<CategoryAxisBuilder<M, V>> {
