...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(ColumnConfig.class)
public class ColumnConfigBuilder<M, N> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<ColumnConfigBuilder<M, N>> {
