...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(Viewport.class)
public class ViewportBuilder extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<ViewportBuilder> {
