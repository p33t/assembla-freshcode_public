...
import biz.freshcode.learn.gwt.mod1.client.experiment.celltable.CellTableDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.ChartDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.area.AreaChartDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.gantt.GanttDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.gantt2.Gantt2Demo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.lanes.LanesChartDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.mixed.MixedChartDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.mixed2.MixedChart2Demo;
import biz.freshcode.learn.gwt.mod1.client.experiment.chart.step.StepChartDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.contextmenu.ContextMenuDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.cookie.CookieDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.dnd.DndUi;
import biz.freshcode.learn.gwt.mod1.client.experiment.dynamiclayout.DynamicLayoutDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.fieldsync.FieldSyncDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.flextable.FlexTableDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.forms.FormsDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.forms2.Forms2Demo;
import biz.freshcode.learn.gwt.mod1.client.experiment.forms3.Forms3Demo;
import biz.freshcode.learn.gwt.mod1.client.experiment.grid.GwtGridDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.grid.GxtGridDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.grid.window.GridWindowDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.gridgroupby.GridGroupByDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.hoverwidget.HoverWidgetDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.iswidget.IsWidgetDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.jsni.JsniDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.layout.LayoutDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.logging.LoggingDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.miscellaneous.HashCodeCheck;
import biz.freshcode.learn.gwt.mod1.client.experiment.mouseover.MouseOverWidget;
import biz.freshcode.learn.gwt.mod1.client.experiment.mvp.gwtmvp.GmPlace;
import biz.freshcode.learn.gwt.mod1.client.experiment.mvp.gwtp.GmdModule;
import biz.freshcode.learn.gwt.mod1.client.experiment.mvp.homebake.HbParent;
import biz.freshcode.learn.gwt.mod1.client.experiment.popfield.PopFieldDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.requestfactory.RequestFactoryDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.resources.ResourcesDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.toolbar.ToolBarDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.tree.TreeDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.triggerfield.TriggerFieldDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.upload.FileUploadDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.window.WindowDemo;
import biz.freshcode.learn.gwt.mod1.client.experiment.xtemplate.XTemplateDemo;
import biz.freshcode.learn.gwt.mod1.client.inject.SessionInfo;
import biz.freshcode.learn.gwt.mod1.client.rpc.dispatch.DispatchDemo;
import biz.freshcode.learn.gwt.mod1.client.rpc.dispatch.SecureDispatchDemo;
import biz.freshcode.learn.gwt.mod1.client.rpc.greet.GreetRpcDemo;
import biz.freshcode.learn.gwt.mod1.client.uibinder.Basic;
import biz.freshcode.learn.gwt.mod1.client.uibinder.Composed;
import biz.freshcode.learn.gwt.mod1.client.uibinder.eg.BorderLayoutEg;
                        ...
                        .addItem(new MenuItem("GXT", subMenu()
                                ...
                                .addItem(new MenuItem("UI Spike", subMenu()
                                        ...
                                        .addItem(new MenuItem("Non UiBuilder", new Command() {
                                            public void execute() {
                                                IsWidget w = GWT.create(biz.freshcode.learn.gwt.mod1.client.uispike.nonuibuilder.UiSpikePanel.class);
                                                replaceRoot(w);
                                            }
                                        }))
                                        .menuBar))
