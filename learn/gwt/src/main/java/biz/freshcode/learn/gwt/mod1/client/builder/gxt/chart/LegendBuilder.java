package biz.freshcode.learn.gwt.mod1.client.builder.gxt.chart;
...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(Legend.class)
public class LegendBuilder<M> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<LegendBuilder<M>> {
