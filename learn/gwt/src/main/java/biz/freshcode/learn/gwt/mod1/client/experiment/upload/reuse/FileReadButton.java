package biz.freshcode.learn.gwt.mod1.client.experiment.upload.reuse;

import biz.freshcode.learn.gwt.common.client.builder.gxt.container.FlowLayoutContainerBuilder;
import biz.freshcode.learn.gwt.mod1.client.util.ClientUtil;
...
public class FileReadButton extends IsWidgetImpl {
    ...
    public static native void observeFileSelect(FileReadButton host, Element e) /*-{
        function handleOnLoad(evt) {
            host.@biz.freshcode.learn.gwt.mod1.client.experiment.upload.reuse.FileReadButton::fileContents(Ljava/lang/String;)(evt.target.result);
        }
