...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(NumericAxis.class)
public class NumericAxisBuilder<M> extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<NumericAxisBuilder<M>> {
