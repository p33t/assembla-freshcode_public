...
@biz.freshcode.learn.gwt2.common.client.builder.BeanBuilder(HTMLPanel.class)
public class HTMLPanelBuilder extends biz.freshcode.learn.gwt2.common.client.builder.Construct.Parent<HTMLPanelBuilder> {
