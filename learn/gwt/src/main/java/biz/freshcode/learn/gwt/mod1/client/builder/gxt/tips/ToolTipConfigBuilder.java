package biz.freshcode.learn.gwt.mod1.client.builder.gxt.tips;
...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(ToolTipConfig.class)
public class ToolTipConfigBuilder extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<ToolTipConfigBuilder> {
