...
@biz.freshcode.learn.gwt.mod1.client.builder.BeanBuilder(HTMLPanel.class)
public class HTMLPanelBuilder extends biz.freshcode.learn.gwt.mod1.client.builder.Construct.Parent<HTMLPanelBuilder> {
