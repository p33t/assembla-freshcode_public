...
@biz.freshcode.learn.gwt.client.builder.BeanBuilder(Menu.class)
public class MenuBuilder extends biz.freshcode.learn.gwt.client.builder.Construct.Parent<MenuBuilder> {
