package biz.freshcode.learn.gwt.common.client.builder.gxt.menu;
...
@biz.freshcode.learn.gwt.common.client.builder.BeanBuilder(Menu.class)
public class MenuBuilder extends biz.freshcode.learn.gwt.common.client.builder.Construct.Parent<MenuBuilder> {
