...
public class PresenterModule extends AbstractPresenterModule {
    ...
    protected void configure() {
        ...
        bindPresenter(RpcSpike.class, RpcSpike.Proxy.class);
        bindPresenter(DownloadableResultSpike.class, DownloadableResultSpike.Proxy.class);
        bindPresenter(FileDownloadSpike.class, FileDownloadSpike.Proxy.class);
