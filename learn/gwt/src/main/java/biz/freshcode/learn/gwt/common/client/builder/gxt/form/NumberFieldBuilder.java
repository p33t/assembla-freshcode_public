...
@biz.freshcode.learn.gwt.common.client.builder.BeanBuilder(NumberField.class)
public class NumberFieldBuilder<N extends Number> extends biz.freshcode.learn.gwt.common.client.builder.Construct.Parent<NumberFieldBuilder<N>> {
