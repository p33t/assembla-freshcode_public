package biz.freshcode.learn.gwt2.common.client.builder.gxt.chart.axis;
...
@biz.freshcode.learn.gwt2.common.client.builder.BeanBuilder(CategoryAxis.class)
public class CategoryAxisBuilder<M, V> extends biz.freshcode.learn.gwt2.common.client.builder.Construct.Parent<CategoryAxisBuilder<M, V>> {
