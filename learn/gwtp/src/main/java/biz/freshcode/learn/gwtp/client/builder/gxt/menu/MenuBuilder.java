...
@biz.freshcode.learn.gwtp.client.builder.BeanBuilder(Menu.class)
public class MenuBuilder extends biz.freshcode.learn.gwtp.client.builder.Construct.Parent<MenuBuilder> {
