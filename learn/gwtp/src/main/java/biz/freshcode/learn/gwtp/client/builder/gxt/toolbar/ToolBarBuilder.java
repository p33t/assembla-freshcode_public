package biz.freshcode.learn.gwtp.client.builder.gxt.toolbar;
...
@biz.freshcode.learn.gwtp.client.builder.BeanBuilder(ToolBar.class)
public class ToolBarBuilder extends biz.freshcode.learn.gwtp.client.builder.Construct.Parent<ToolBarBuilder> {
