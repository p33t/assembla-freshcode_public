...
@biz.freshcode.learn.gwtp.client.builder.BeanBuilder(NumberField.class)
public class NumberFieldBuilder<N extends Number> extends biz.freshcode.learn.gwtp.client.builder.Construct.Parent<NumberFieldBuilder<N>> {
