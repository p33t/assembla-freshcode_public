...
@biz.freshcode.learn.gwtp.client.builder.BeanBuilder(SpinnerField.class)
public class SpinnerFieldBuilder<N extends Number> extends biz.freshcode.learn.gwtp.client.builder.Construct.Parent<SpinnerFieldBuilder<N>> {
